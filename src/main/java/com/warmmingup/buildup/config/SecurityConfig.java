...
//        TokenProvider tokenProvider = ObjectTokenProvider.getObject();
        http
                // CSRF 설정 Disable
                .csrf().disable()
                // exception handling
...
//                    .antMatchers("/auth/**").hasAnyRole("NO", "NAME")  // 나머지 API 는 전부 인증 필요
                .and()
                .cors()
                .and()
...
//        System.out.println("tokenProvider 는 : " + tokenProvider);
    }
