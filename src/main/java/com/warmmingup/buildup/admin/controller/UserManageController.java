...
public class UserManageController {
    ...
    public ResponseEntity<ResponseDTO> getAllUsers(@RequestParam(name = "page", defaultValue = "1") int page, @RequestParam(name = "search", defaultValue = "") String search) {
    ...
    public ResponseEntity<ResponseDTO> getUserInfo(@PathVariable int userNo) {
